...
SVC_NAME="actions.runner.hieulnt-aiot-fullstack-docker-ci-cd.fullstack-docker-app-demo"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (hieulnt-aiot-fullstack-docker-ci-cd.fullstack-docker-app-demo)"
